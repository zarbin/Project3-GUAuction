...
//contract to create open aunction for God's Unchained (GU) Art
contract GUArtAuction {
    address deployer;  //foundation - ether will be transferred here
    ...
    constructor(
        ...
        deployer = msg.sender; // set as the GUArtMarket
